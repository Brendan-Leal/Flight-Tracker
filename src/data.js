...
// I converted airlines into an object so that the getAirportByCode
// function will take O(1) time.
const airportCodeAndName = (() => {
  console.log("Converting airlines array into an object...");
  let codeAndNames = {};
  airports.forEach(a => {
    codeAndNames[a.code] = a.name;
  });
  return codeAndNames;
})();
...
function getAirlineById(id) {
  let airline = airlines.filter(a => a.id === id);
  return airline[0].name;
}

function getAirportByCode(code) {
  return airportCodeAndName[code];
}
